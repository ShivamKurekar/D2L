// Code for Master for Dual Data Link (D2L)
...
module master (
    ...
    reg [70:0] data = {7'd8, 56'd95, 8'b0101_1010};
    reg DL0, DL1;
    reg [6:0]  d_width;
    reg [63:0] shreg;
    ...
    always@(posedge clk) begin
        out_en_delay <= enable_in;
    end
    assign out_en = (enable_in && (~out_en_delay));
    ...
    always @(*) begin
        ...
        case(state)
            ...
            DATA_TX: begin
                ...
                DL0 = shreg[d_width - 2]; //Lower half bits
                DL1 = shreg[d_width - 1]; //Upper half bits
                CS  = 1'd0;
